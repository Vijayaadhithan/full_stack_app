...
fun AccountDeletionScreen(
    ...
    val url = BuildConfig.ACCOUNT_DELETION_URL.trim()
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Account Deletion", color = WhiteText) },
                navigationIcon = {
        ...
        if (url.isBlank()) {
            Box(
                ...
                Text(
                    text = "Account deletion URL is not configured.",
                    color = ErrorRed,
        ...
        if (!isValidUrl) {
            Box(
                ...
                Text(
                    text = "Account deletion URL must use HTTPS.",
                    color = ErrorRed,
                    style = MaterialTheme.typography.bodyMedium
                )
            }
                    ...
                    WebView(context).apply {
                        ...
                        webViewClient = object : WebViewClient() {
                            ...
                            override fun onReceivedError(
                                ...
                                if (request?.isForMainFrame == true) {
                                    ...
                                    errorMessage = error?.description?.toString()
                                        ?: "Failed to load account deletion details."
                                }
                            }
                            ...
                            override fun onReceivedSslError(
                                ...
                                handler?.cancel()
                                isLoading = false
                                errorMessage = "Secure connection error while loading account deletion details."
                            }
                        }
